...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <h1 className="text-3xl md:text-5xl font-bold tracking-tighter">UCSD Food Co-op</h1>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
              We believe that access to nutritious food is a right, not a privilege. Our co-op works to create a more
              equitable food system at UCSD and beyond.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#F5F5F0] p-6 rounded-lg">
              ...
              <h3 className="text-xl font-semibold mb-2">Food Justice</h3>
              <p className="text-gray-600">
                We work to address food insecurity on campus through mutual aid, education, and advocacy.
              </p>
            </div>
            ...
            <div className="bg-[#F5F5F0] p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                We create spaces for students to connect, share skills, and support each other.
              </p>
            </div>
            ...
            <div className="bg-[#F5F5F0] p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                We host workshops on cooking, gardening, and food preservation to build collective knowledge.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 mb-4">Join Our Community</h2>
              <p className="text-lg text-gray-600 mb-6">
                The Food Co-op welcomes students of all backgrounds and experience levels. Whether you're passionate
                about food justice, looking to learn new skills, or simply want to connect with others, there's a place
                for you here.
              </p>
              <ul className="space-y-3 mb-6">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600">Attend our weekly meetings</span>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 mt-1 bg-[#4A6741] rounded-full p-1">
                    <svg className="h-3 w-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="text-gray-600">Volunteer at our food distribution events</span>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 mt-1 bg-[#4A6741] rounded-full p-1">
                    <svg className="h-3 w-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="text-gray-600">Participate in workshops and skill shares</span>
                </li>
              </ul>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 mb-8 text-center">Upcoming Events</h2>
            ...
            {[
              {
                ...
                description: "Free groceries for UCSD students. Bring your student ID and reusable bags.",
              },
              {
              ...
              },
              {
                ...
                description: "Join us to learn about the co-op, meet current members, and find ways to get involved.",
              },
            ].map((event, index) => (
      ...
      <section className="py-16 bg-[#F5F5F0]">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 mb-8 text-center">Community Voices</h2>
      ...
      <section className="py-16 bg-[#4A6741] text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-3xl font-bold tracking-tight mb-4">Ready to Join Our Community?</h2>
          <p className="text-lg text-white/90 max-w-2xl mx-auto mb-8">
            Whether you're looking for food resources, want to volunteer, or are interested in learning more about food
            justice, we'd love to welcome you to the UCSD Food Co-op.
          </p>
