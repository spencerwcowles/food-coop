      ...
      <section className="bg-[#4A6741] text-white py-16">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
            Access information about food assistance, cooking guides, and other
            resources to support your food security.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="bg-[#F9B872]/20 border border-[#F9B872] rounded-lg p-6 md:p-8 mb-12">
            ...
            <p className="text-lg mb-6 text-gray-800">
              If you're experiencing food insecurity and need immediate
              assistance, these resources can help:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Free groceries for all UCSD students
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <p className="text-sm text-gray-500">
                    Bring your student ID. No appointment needed.
                  </p>
                </CardContent>
                <CardFooter>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-500">
                    Offers emergency meal swipes, CalFresh assistance, and more.
                  </p>
                </CardContent>
                <CardFooter>
                  <Button asChild variant="outline" className="w-full">
                    <Link
                      href="https://basicneeds.ucsd.edu/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Visit Website
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-500">
                    Open to all. No ID required. Bring reusable bags if
                    possible.
                  </p>
                </CardContent>
                <CardFooter>
            ...
            {[
              {
                ...
                description:
                  "Free groceries for all UCSD students with a valid student ID.",
                link: "https://basicneeds.ucsd.edu/food-security/pantry/index.html",
              },
              {
                title: "CalFresh Assistance",
                description:
                  "Get help applying for CalFresh (food stamps) benefits worth up to $250/month.",
                link: "https://basicneeds.ucsd.edu/food-security/calfresh/index.html",
              },
              {
                title: "Emergency Meal Swipes",
                description:
                  "Access to free dining hall meals for students experiencing food insecurity.",
                link: "https://basicneeds.ucsd.edu/food-security/dining-dollars/index.html",
              },
              {
                title: "Community Gardens",
                description:
                  "Join campus gardens to grow your own food and learn gardening skills.",
                link: "/resources/community-gardens",
              },
              {
                title: "Farmers Market",
                description:
                  "Weekly campus farmers market with fresh, local produce (accepts EBT).",
                link: "https://ucsdcommunityhealth.org/work/farmers-market/",
              },
              {
                title: "Food Recovery Network",
                description:
                  "Volunteer to help recover and redistribute surplus food from campus dining halls.",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Connect to a variety of community services, including food assistance, by dialing 2-1-1.",
              ...
              },
              {
                ...
                website:
                  "https://www.sandiegocounty.gov/content/sdc/hhsa/programs/phs/wic_program.html",
                phone: "(800) 500-6411",
              },
            ].map((resource, index) => (
              <Card key={index}>
      ...
      <section className="py-16 bg-[#F5F5F0]">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12">
            Explore these resources to learn more about food systems, cooking on
            a budget, nutrition, and food justice.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                ...
                description:
                  "Simple, affordable recipes designed for college students with limited time and budget.",
                type: "PDF Guide",
                icon: Download,
              },
              {
                ...
                description:
                  "Learn about balanced nutrition and how to make healthy choices on a student budget.",
                type: "Online Guide",
                icon: ExternalLink,
              },
              {
                ...
                description:
                  "An introduction to food justice concepts and how they relate to our campus community.",
              ...
              },
              {
                ...
                description:
                  "Save time and money by learning how to effectively meal prep for the week.",
                type: "PDF Guide",
                icon: Download,
              },
              {
                ...
                description:
                  "Resources for eating plant-based meals while keeping costs low.",
              ...
              },
              {
                ...
                description:
                  "Learn how to make your food last longer and reduce waste.",
                type: "Video Series",
                icon: ExternalLink,
              },
            ].map((resource, index) => (
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  CalFresh provides monthly benefits that can be used to buy
                  groceries at supermarkets, farmers markets, and some online
                  retailers. As a student, you may be eligible if you meet
                  certain criteria.
                </p>
                <div className="bg-[#F5F5F0] p-4 rounded-lg mb-4">
                  <h4 className="font-medium mb-2">
                    Student Eligibility (one of the following):
                  </h4>
                ...
                <p className="text-gray-600">
                  Benefits can be up to $250 per month for a single student. The
                  Basic Needs Hub can help you apply!
                </p>
              </CardContent>
              <CardFooter>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  UCSD offers emergency meal swipes for students experiencing
                  food insecurity. These provide temporary access to campus
                  dining halls while you connect with longer-term resources.
                </p>
                <p className="text-gray-600">
                  You can request up to 10 meal swipes per quarter through the
                  Basic Needs Hub. The process is confidential and designed to
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Our Food Co-op operates a mutual aid fund that can provide
                  grocery gift cards to students in need. This program is based
                  on the principle of "from each according to ability, to each
                  according to need."
                </p>
                <p className="text-gray-600">
                  Requests are confidential and can be made through our online
                  form or in person at our weekly meetings. No documentation
                  required - we trust our community members to request what they
                  need.
                </p>
              </CardContent>
              <CardFooter>
      ...
      <section className="py-16 bg-[#4A6741] text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto mb-8">
            Our Food Co-op members can help you find the right resources for
            your situation. Reach out to us for personalized assistance.
          </p>
